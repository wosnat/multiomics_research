...
class TestRankOntologies:
    def test_ranking_returns_dataframe(self):
        ...
        profiles = {
            "GO": {"coverage": 0.9, "per_level": [{"level": 1, "n_terms_with_genes": 10,
                                                     "min_genes": 1, "q1_genes": 5,
                                                     "median_genes": 20, "q3_genes": 50,
                                                     "max_genes": 200}]},
            "KEGG": {"coverage": 0.5, "per_level": [{"level": 1, "n_terms_with_genes": 5,
    ...
    def test_higher_coverage_ranks_first(self):
        """Ontology with higher coverage should rank first when median is comparable."""
        profiles = {
            "HighCov": {"coverage": 0.9, "per_level": [{"level": 1, "n_terms_with_genes": 5,
                                                          "min_genes": 2, "q1_genes": 5,
                                                          "median_genes": 15, "q3_genes": 30,
                                                          "max_genes": 100}]},
            "LowCov": {"coverage": 0.3, "per_level": [{"level": 1, "n_terms_with_genes": 5,
                                                         "min_genes": 2, "q1_genes": 5,
                                                         "median_genes": 15, "q3_genes": 30,
                                                         "max_genes": 100}]},
        }
